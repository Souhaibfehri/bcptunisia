...
import { AdminCreateUserDirectForm } from "@/components/admin/AdminCreateUserDirectForm";
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-bcp-border bg-white p-6 shadow-sm">
        ...
        <AdminInviteUserForm clients={clients ?? []} />
      </section>
      ...
      <section className="rounded-2xl border border-bcp-border bg-white p-6 shadow-sm">
        ...
        <AdminCreateUserDirectForm clients={clients ?? []} />
      </section>
